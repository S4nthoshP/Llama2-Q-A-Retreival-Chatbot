### All recommended models/values for certain constants were researched/obtained 
###through public sources like huggingface , github etc.
...
### For example Llama-2-7B-Chat-GGML model on 8GB VRAM, these values work:
# N_GPU_LAYERS = 20
# N_BATCH = 512
...
EMBEDDING_MODEL_NAME = "intfloat/e5-small-v2"  # Uses 1.5 GB of VRAM (High Accuracy with lower VRAM usage)
